var messages=["Developer","Designer","Coder"];
var rank=0;
...
function changeTxt(e){
  ...
  _h1.style.webkitAnimation = 'none'; // set element animation to none
   setTimeout(function() { // you surely want a delay before the next message appears
      ...
      _h1.style.webkitAnimation = 'typing '+speed+'s steps(20, end), blink-caret .75s step-end infinite'; //  switch to the original set of animation      
